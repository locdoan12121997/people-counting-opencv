...
lines = [((0, 150), (500, 150), 'down'), ((0, 300), (500, 300), 'up')]
FRAMEPERSEC = 24.0
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter('output.mp4',fourcc, FRAMEPERSEC, (500, 281))
...
class LineFunction(object):
	...
	def fx(self, point):
		return (point[0] - self.point1[0]) * (self.point2[1] - self.point1[1]) - (point[1] - self.point1[1]) * (self.point2[0] - self.point1[0])
...
while True:
	...
	fps.update()
	frame_number += 1
	print(stay_estimator.calculate_average_duration())
